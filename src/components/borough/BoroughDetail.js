    ...
    <div className="relative group mb-8">
      ...
      <div className="mx-auto px-12 py-10 bg-white shadow-2xl rounded-3xl my-6">
        ...
        <div className="space-y-8">
          {borough.transportation.subway_lines.length > 0 && (
            <div>
              <h3 className="text-4xl font-bold text-gray-800">
                Subway Access
              </h3>
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 mt-4">
                {borough.transportation.subway_lines.map((subwayLine) => (
                  <div
                    key={subwayLine}
          ...
          {borough.transportation.bus_lines.length > 0 && (
            <div>
              ...
              <div className="grid grid-cols-3 md:grid-cols-5 lg:grid-cols-8 gap-4 mt-4">
                {borough.transportation.bus_lines.map((busRoute) => (
                  <div
                    key={busRoute}
                    className="flex items-center justify-center bg-gray-200 rounded-lg p-4 hover:bg-gray-300 transition-colors duration-300"
                  >
          ...
          {borough.transportation.walkability && (
            <div>
          ...
          {borough.transportation.bike_paths && (
            <div>
